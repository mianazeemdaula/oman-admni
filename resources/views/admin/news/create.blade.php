    ...
    <form action="{{ route('news.store') }}" method="post" enctype="multipart/form-data">
        ...
        <div class="mt-4 bg-white">
            <div class="bg-blue-500  p-2">
                <h2 class="text-white">Add New News</h2>
            </div>
            <div class="grid grid-cols-1 md:grid-cols-1 p-2 gap-2 md:p-4">
                <div>
                    <h3 class="p-1">Title</h3>
                    <input type="text" placeholder="tiltle" name="tittle" value="{{ old('tittle') }}" class="w-80">
                    @error('tittle')
                ...
                <div>
                    ...
                    <textarea name="body" id="" cols="50" rows="10" class="p-4 border">{{ old('body') }}</textarea>
                    @error('body')
                        <p class="text-red-500 text-xs italic">{{ $message }}</p>
                    @enderror
                </div>
