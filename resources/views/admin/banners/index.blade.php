                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        @foreach ($collection as $item)
                            <tr class="border-b-2">
                                ...
                                <td class="">
                                    <img src="{{ $item->image }}" class="w-10 h-10 rounded-full" alt=""
                                        srcset="">
                                </td>
                                <td class="flex space-x-1">
                                    <a href="{{ route('banners.show', $item->id) }}"><span class="bi bi-eye"></span></a>
                                    <a href="{{ route('banners.edit', $item->id) }}"><span class="bi bi-pencil"></span></a>
