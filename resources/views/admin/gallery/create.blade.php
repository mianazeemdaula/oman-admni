    ...
    <form action="{{ route('banners.store') }}" method="post" enctype="multipart/form-data">
        ...
        <div class="mt-4 bg-white">
            <div class="bg-blue-500  p-2">
                <h2 class="text-white">Add New Banner</h2>
            </div>
            <div class="grid grid-cols-1 md:grid-cols-1 p-2 gap-2 md:p-4">
                <div>
                    <h3 class="p-1">Title</h3>
                    <input type="text" placeholder="tiltle" name="title" value="{{ old('title') }}" class="w-80">
                    @error('title')
                ...
                <div>
                    ...
                    <label for="avatar" class="relative">
                        <img src="https://placehold.co/32x20" alt="image" class="rounded-md w-32 h-20">
