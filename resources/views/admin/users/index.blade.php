                        ...
                        @foreach ($collection as $item)
                            <tr class="border-b-2">
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500"><img
                                        src="{{ $item->picture }}" alt="" srcset=""
                                        class="w-10 h-10 object-cover rounded-sm    "></td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{{ $item->first_name }}
                                    {{ $item->second_name }}</td>
                                ...
                                <td class="flex space-x-1">
                                    <a href="{{ route('users.show', $item->id) }}"><span class="bi bi-eye"></span></a>
