...
use App\Models\ExitCountry;
use App\Models\NewsImage;
use Image;

class ExitCountryController extends Controller
{
    /**
    ...
    {
        $collection = ExitCountry::where('status','PENDING')->get();
        return view('admin.exits.index', compact('collection'));
    }
